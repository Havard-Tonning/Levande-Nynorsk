...
public class CreateDict {
    public CreateDict() {
        ...
        try (FileWriter writer = new FileWriter("src/main/java/preprocessing/wordList.csv")) {
        ...
        System.out.println("Wrote " + counter + " words to wordList.csv");
    }
        ...
        if(!lemmas.isEmpty()){
            ...
            if(!paradigmInfo.isEmpty()){
                ...
                if(!tags.isEmpty()){
                    ...
                    if(Objects.equals(articleTags[0], "NOUN")){
            ...
            System.out.println("The word " + word + " belongs to " + articleTags[0] + "(and is " + articleTags[1] + ")");
